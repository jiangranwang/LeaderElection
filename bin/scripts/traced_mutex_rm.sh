...
drop_rates=(0.1 0.15 0.2 0.25 0.35)
# drop_rates=(0.05 0.1 0.15 0.2 0.25 0.35)
...
# echo "" > "../analyze/outputs/P_zipfian.txt"
...
#         fi
#         ./run.sh $config_name
#         cat stats.json >> "../analyze/outputs/P_zipfian.txt"
#     done
# done
...
# # drop rate 0.05
# # random topos
# echo "" > "../analyze/outputs/W_zipfian.txt"
...
#         fi
#         ./run.sh $config_name
#         cat stats.json >> "../analyze/outputs/W_zipfian.txt"
#     done
# done 
...
#     fi
#     ./run.sh $config_name
#     cat stats.json >> "../analyze/outputs/W_uniform.txt"
# done
...
# trace_path="../../YCSB/analyze/traces/W.txt"
# tmp="$(mktemp)"
...
#     jq --arg trace_path "$trace_path" '.trace_file = $trace_path' $config_name > "$tmp"
#     mv "$tmp" $config_name
#     echo "" > "../analyze/outputs/${distro}_uniform.txt"
#     for num_serv in ${num_servers[@]}; do
#         # modify N
#         tmp="$(mktemp)"
#         jq --arg num_serv "$num_serv" '.num_servers = $num_serv' $config_name > "$tmp"
...
#             fi
#             ./run.sh $config_name
#             cat stats.json >> "../analyze/outputs/${distro}_uniform.txt"
#         done
#     done 
# done
